 ...
 * Use the {@link AccountFragment1#newInstance} factory method to
...
public static AccountFragment1 newInstance(){
    AccountFragment1 fragment1 = new AccountFragment1();
    return fragment1;
}
    public AccountFragment1() {
    ...
    public static AccountFragment1 newInstance(String param1, String param2) {
        AccountFragment1 fragment = new AccountFragment1();
